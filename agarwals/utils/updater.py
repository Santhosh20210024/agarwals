...
def update_utr_in_separate_column():
    ...
    utr_in_bank_transaction_update_query = "UPDATE `tabBank Transaction` SET custom_cg_utr_number = TRIM(TRIM(LEADING '0' FROM reference_number)) WHERE custom_cg_utr_number is null"
