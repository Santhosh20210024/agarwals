...
def import_job():
        ...
        data_import_doc.set('reference_doctype', 'Region')
        data_import_doc.set('import_type', 'Insert New Records')
        data_import_doc.set('import_file', '/private/files/Region (3)f8f22f.csv')
        data_import_doc.save()
        try:
            data_import_doc.start_import()
            print('_______________________________________________________import started')
        except Exception as e:
